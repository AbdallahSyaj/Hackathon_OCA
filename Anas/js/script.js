const users = [
    {
      ...
      phone: "12345678",
      address: "Amman",
      bio: "Helping others is my passion.",
      total_donation: 100,
      volunter_hours: 5,
    },
    {
      ...
      phone: "87654321",
      address: "Zarqa",
      bio: "Love contributing to charity events.",
      total_donation: 200,
      volunter_hours: 10,
    },
  ];
  ...
  const activities = [
    {
      ...
      activity_description: "Help distribute food to families in need.",
      activity_image: "https://dubaitickets.tours/wp-content/uploads/2023/03/img-worlds-of-adventure-dubai-ticket-9.jpg",
    ...
    {
      activity_id: 2,
      activity_name: "Clothes Donation",
      activity_description: "Donate and organize clothes for winter relief.",
      activity_image: "https://www.hollywoodreporter.com/wp-content/uploads/2012/12/img_logo_blue.jpg",
      location: "Community Center, Zarqa",
